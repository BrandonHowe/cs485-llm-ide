...
import { mountVSCloneChatHistoryRail } from './preact/out/chat-history-rail/index.js';
...
export class VSCloneChatHistoryRail extends Disposable {
	...
	render(container: HTMLElement): void {
		...
		this.mountedView = mountVSCloneChatHistoryRail(container, this.createViewProps()) as IVSCloneMountedView<IVSCloneRailViewProps> | undefined;
	}
	...
	private createViewProps(): IVSCloneRailViewProps {
		return {
			...
			deleteTitleId: `vsclone-chat-history-delete-title-${this.deleteDialogId}`,
			deleteDescriptionId: `vsclone-chat-history-delete-description-${this.deleteDialogId}`,
