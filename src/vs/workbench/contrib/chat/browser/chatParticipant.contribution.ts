...
// VSClone: native chat view container/view disabled - VSClone provides its own sidebar.
// Mirroring Void's approach: we leave the rest of the contribution intact (extension point,
// participant registration, view-welcome content) so the chat services keep working but no
// auxiliary-bar chat icon, view, or keybinding is registered.
